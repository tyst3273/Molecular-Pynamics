...
## Input parameters ##
infile = 'gas.xyz' #positions
dump = 50
thermo = 100
elem = 'argon'
nondim = 'argon' #enter the atomic type for dimensionless LJ, otherwise no
dist = 'custom' #velocity distribution
val = 'vInit.xyz' #value of constant velocity distibution
dt = 0.002 #0.002 #timestep in ps ?
tTot = 100 #ps ?
